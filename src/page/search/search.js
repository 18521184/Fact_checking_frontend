      ...
      <div>
        ...
        {data.answer && <div className='search__result'>
          <div className='result'>
            ...
            <p>With your sentences: <span className='sentence--modifile'> {data.query} </span></p>
            <p>
              - With the above search and accuracy we conclude this sentence: <span className={data.answer ? 'txt-green' : 'txt-red'}>{data.answer}</span>
            </p>
            <p>
